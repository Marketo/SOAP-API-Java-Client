 ...
 * 
 */
@WebServiceClient(name = "MktMktowsApiService", targetNamespace = "http://www.marketo.com/mktows/", wsdlLocation = "http://app.marketo.net/soap/mktows/2_1?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://app.marketo.net/soap/mktows/2_1?WSDL");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://app.marketo.net/soap/mktows/2_1?WSDL', retrying as a local file");
