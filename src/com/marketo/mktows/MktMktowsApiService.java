 ...
 * 
 */
@WebServiceClient(name = "MktMktowsApiService", targetNamespace = "http://www.marketo.com/mktows/", wsdlLocation = "https://app-qe.marketo.com/soap/mktows/2_2?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "https://app-qe.marketo.com/soap/mktows/2_2?WSDL");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'https://app-qe.marketo.com/soap/mktows/2_2?WSDL', retrying as a local file");
